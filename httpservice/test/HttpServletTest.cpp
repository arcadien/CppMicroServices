...
{
  // GET_MISSING_HOST_HEADER_RUQUEST is accepted in CivetWeb as a normal httprequest
  ...
  testEnv.HttpSend(Queries::GET_MISSING_HOST_HEADER_RUQUEST);
...
{
  auto response = cppmicroservices::HttpServletResponse::Create();
